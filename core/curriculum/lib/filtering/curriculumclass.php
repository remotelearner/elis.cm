...
require_once($CFG->dirroot.'/curriculum/lib/filtering/nofilterdate.php');
...
class generalized_filter_curriculumclass extends generalized_filter_multifilter  {
    ...
    const filtertype_nofilterdate = 'nofilterdate';
    ...
    protected $fieldtofiltermap = array(
        ...
        'class' => array(
            ...
            'startdate'         => generalized_filter_curriculumclass::filtertype_nofilterdate,
    ...
    function make_filter_options_custom($options, $group, $name) {
        ...
        switch ($group) {
            case 'curriculum':
                ...
                $options['wrapper'] = " INNER JOIN {$CFG->prefix}crlm_curriculum_assignment cca"
            ...
            case 'course':
                ...
                $options['wrapper'] = " INNER JOIN {$CFG->prefix}crlm_class cls"
