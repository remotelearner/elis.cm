 ...
 *
 * exists_select.php - PHP Report filter for extra user profile menu fields
 *
 * Filter for matching on tables not to be included in the main report
 *
 * Required options include: all select filter requirements PLUS
