    ...
    public function definition() {
        ...
        if (isset($this->_customdata['obj'])) {
            ...
            $mform->addElement('static', 'enrolall', null,
                               "<button onclick=\"location.href=&quot;index.php?s=trkcls&amp;action=enrolall&amp;id=$trackid&amp;association_id=$aid&quot;; return false\"/>".get_string('enrol_all_users_now', 'block_curr_admin').'</button>');
        }
