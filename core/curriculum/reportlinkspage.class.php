...
/// Page for linking to extrnal class reports
class class_reportlinkspage extends newpage {
    ...
    function can_do_default() {
        ...
        return cmclasspage::_has_capability('block/curr_admin:viewreports', $id)
    ...
    function action_default() {
        ...
        $record = $CURMAN->db->get_record('crlm_class', 'id', $id);
        ...
        $class_roster_report_name = get_string('classrosterreport', 'block_curr_admin');
        ...
        $class_completion_report_name = get_string('classcompletionreport', 'block_curr_admin');
