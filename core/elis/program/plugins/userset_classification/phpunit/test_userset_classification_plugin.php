...
class usersetClassificationTest extends elis_database_test {
    ...
    public function testInstall() {
        ...
        $this->assertTrue($DB->record_exists(field_owner::TABLE, array('fieldid' => $field->id, 'plugin' => 'userset_classification')));
    }
}
