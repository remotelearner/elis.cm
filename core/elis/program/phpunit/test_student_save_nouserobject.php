...
class student_save_nouserobject_test extends elis_database_test {
    ...
    /**
     * Required overlay tables for tests
     * @return array the required overlay tables
     */
    static protected function get_overlay_tables() {
        ...
        if (file_exists($CFG->dirroot.'/local/completiontransaction/version.php')) {
            $overlays['local_completiontransaction'] = 'local_completiontransaction';
        }
        return $overlays;
    }
