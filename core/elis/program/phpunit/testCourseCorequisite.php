 ...
 */
class coursecorequisiteTest extends elis_database_test {
    ...
    protected function load_csv_data() {
        ...
        $dataset->addTable(coursecorequisite::TABLE, elis::component_file('program', 'phpunit/coursecorequisite.csv'));
