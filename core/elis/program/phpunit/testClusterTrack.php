...
class clustertrackTest extends elis_database_test {
     ...
     */
    public function testClusterTrackValidationPreventsDuplicates() {
        $this->load_csv_data();

        $clustertrack = new clustertrack(array('clusterid' => 1,
                                               'trackid' => 1));
