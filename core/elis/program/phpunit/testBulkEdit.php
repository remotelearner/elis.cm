...
class bulkeditTest extends elis_database_test {
    ...
    public function testBulkApplyAll() {
        global $SESSION, $_GET;
    ...
    public function testBulkCheckboxSelectionDeselectAll() {
        global $SESSION, $_GET;
    ...
    public function testBulkCheckboxSelectionReset() {
        global $SESSION, $_GET;
    ...
    public function testBulkCheckboxSelectionSession() {
    ...
    public function testCheckboxSelectionSession() {

    }

    public function testRetrieveSessionSelectionBulkedit() {
    ...
    public function testRetrieveSessionSelection() {
        global $SESSION, $_GET;
    ...
    public function testPrintCheckboxSelection() {
        global $SESSION;
    ...
    public function testPrintIdsForCheckboxSelection() {
        $page = 'test';
        $classid = 1;
        $target = 'test';
    ...
    public function testSessionSelectionDeletion() {
        global $SESSION, $_GET;
    ...
    public function testSessuser2formuser() {
