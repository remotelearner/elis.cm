...
function xmldb_elis_program_upgrade($oldversion=0) {
    ...
    if ($result && $oldversion < 2013042900) {
        ...
        if ($dbman->table_exists($table)) {
            ...
            // Remove any duplicate records before attempting to apply an index.
    ...
    if ($result && $oldversion < 2013051507) {
        ...
        upgrade_plugin_savepoint($result, 2013051507, 'elis', 'program');
    }
