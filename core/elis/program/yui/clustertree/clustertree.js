    ...
    Y.extend(MODULEBASE, Y.Base, {
        ...
        clustertree_set_up_onclick : function(instanceid, contentelid, uniqueid, treeview) {
            ...
            if (el) {
                ...
                YAHOO.util.Event.addListener(contentelid, 'click',  document.clustertreescope.clustertree_handler_func, params, false);
            }
        },
        ...
        clustertree_get_container_elements_by_name : function(instanceid, elementname) {
            var result = YAHOO.util.Dom.getElementsBy(function(el) { return el.name == elementname; }, '', 'php_report_body_'+instanceid);
            return result;
        },
        ...
        clustertree_render_tree : function(instanceid, uniqueid, treeobject, executionmode) {
            var clusterparamtree = new YAHOO.widget.TreeView("cluster_param_tree_"+instanceid+"_"+uniqueid, treeobject.children);
